...
#' @export
#' @noRd
summary.spp_test <- function(obj, pp_stat = "tau",
                             ...) {
  ...
  if(pp_stat == "tau") {
    ...
    if(sim_hyp == "nonstationary") {
      sum1 <- paste0("Potential thresholds for your consideration: ", round(subset(tau_results, type == "No Drift, No Trend")[1, 2], 3), " (1%); ",
                     round(subset(tau_results, type == "No Drift, No Trend")[1, 3], 3), " (5%); ",
                     round(subset(tau_results, type == "No Drift, No Trend")[1, 4], 3), " (10%)")

      sum2 <- paste0("Potential thresholds for your consideration: ", round(subset(tau_results, type == "Drift, No Trend")[1, 2], 3), " (1%); ",
                     round(subset(tau_results, type == "Drift, No Trend")[1, 3], 3), " (5%); ",
                     round(subset(tau_results, type == "Drift, No Trend")[1, 4], 3), " (10%)")

      sum3 <- paste0("Potential thresholds for your consideration: ", round(subset(tau_results, type == "Drift and Trend")[1, 2], 3), " (1%); ",
                     round(subset(tau_results, type == "Drift and Trend")[1, 3], 3), " (5%); ",
                     round(subset(tau_results, type == "Drift and Trend")[1, 4], 3), " (10%)")
      ...
      sum1 <- paste0("Potential thresholds for your consideration: ", round(subset(tau_results, type == "No Drift, No Trend")[1, 5], 3), " (90%); ",
                     round(subset(tau_results, type == "No Drift, No Trend")[1, 6], 3), " (95%); ",
                     round(subset(tau_results, type == "No Drift, No Trend")[1, 7], 3), " (99%); ")

      sum2 <- paste0("Potential thresholds for your consideration: ", round(subset(tau_results, type == "Drift, No Trend")[1, 5], 3), " (90%); ",
                     round(subset(tau_results, type == "Drift, No Trend")[1, 6], 3), " (95%); ",
                     round(subset(tau_results, type == "Drift, No Trend")[1, 7], 3), " (99%)")

      sum3 <- paste0("Potential thresholds for your consideration: ", round(subset(tau_results, type == "Drift and Trend")[1, 5], 3), " (90%); ",
                     round(subset(tau_results, type == "Drift and Trend")[1, 6], 3), " (95%); ",
                     round(subset(tau_results, type == "Drift and Trend")[1, 7], 3), " (99%)")
